...
type (
	Borrower struct {
		...
		IdCardNumber         string    `json:"idcard_number" gorm:"column:idcard_number,type:varchar(255);not null"`
		...
		Dependants           int       `json:"dependants" gorm:"column:dependants,type:int;not null"`
